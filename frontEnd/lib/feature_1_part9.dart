...
class Feature1Part9 extends StatefulWidget {
  const Feature1Part9({super.key});

  @override
  State<Feature1Part9> createState() => _Feature1Part9State();
}

class _Feature1Part9State extends State<Feature1Part9> {
  ...
  void initState() {
    super.initState();
    int maxRooms =
        BlueprintSelections.bedroomSelectionsByFloor['second'] != null
            ? BlueprintSelections.maxRoomSelectionValue(
                BlueprintSelections.bedroomSelectionsByFloor['second']!)
            : 1;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  const Text(
                    "Select rooms to add attached bathroom to (2nd floor only)",
                    style: TextStyle(
                      fontSize: 14,
                      ...
                      ElevatedButton(
                        onPressed: selectedRooms.isNotEmpty
                            ? () {
                                ...
                                BlueprintSelections
                                        .bathroomSelectionsByFloor['second'] =
