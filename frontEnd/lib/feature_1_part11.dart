...
class _Feature1Part11State extends State<Feature1Part11> {
  ...
  void initState() {
    super.initState();
    int maxRooms =
        BlueprintSelections.bedroomSelectionsByFloor['fourth'] != null
            ? BlueprintSelections.maxRoomSelectionValue(
                BlueprintSelections.bedroomSelectionsByFloor['fourth']!)
            : 1;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  const Text(
                    "Select rooms to add attached bathroom to (4th floor only)",
                    style: TextStyle(
                      fontSize: 14,
                      ...
                      ElevatedButton(
                        onPressed: selectedRooms.isNotEmpty
                            ? () {
                                ...
                                BlueprintSelections
                                        .bathroomSelectionsByFloor['fourth'] =
                                    List<String>.from(selectedRooms);
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          const Feature1Part12()),
                                );
                              }
                            : null,
                        style: ElevatedButton.styleFrom(
