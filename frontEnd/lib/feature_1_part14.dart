...
class Feature1Part14 extends StatefulWidget {
  const Feature1Part14({super.key});

  @override
  State<Feature1Part14> createState() => _Feature1Part14State();
}

class _Feature1Part14State extends State<Feature1Part14> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  const Text(
                    "How many living rooms should include in second floor?",
                    style: TextStyle(
                      fontSize: 14,
                    ...
                    child: ElevatedButton(
                      onPressed: selectedRooms.isNotEmpty
                          ? () {
                              ...
                              BlueprintSelections
                                      .livingRoomSelectionsByFloor['second'] =
                                  List<String>.from(selectedRooms);
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>
                                        const Feature1Part15()),
                              );
                            }
                          : null,
