...
import 'package:archisri_1/feature_1_part9.dart';
...
class Feature1Part8 extends StatefulWidget {
  const Feature1Part8({super.key});

  @override
  State<Feature1Part8> createState() => _Feature1Part8State();
}

class _Feature1Part8State extends State<Feature1Part8> {
  ...
  void initState() {
    super.initState();
    int maxRooms = BlueprintSelections.bedroomSelectionsByFloor['first'] != null
        ? BlueprintSelections.maxRoomSelectionValue(BlueprintSelections.bedroomSelectionsByFloor['first']!)
        : 1;
                      ...
                      ElevatedButton(
                        onPressed: selectedRooms.isNotEmpty
                            ? () {
                                ...
                                BlueprintSelections.bathroomSelectionsByFloor['first'] = List<String>.from(selectedRooms);
                                
                                int floorCount = BlueprintSelections.floors;
                                Widget nextScreen;
                                if (floorCount >= 2) {
                                  nextScreen = const Feature1Part9();
                                } else {
