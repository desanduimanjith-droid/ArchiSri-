...
import 'package:archisri_1/feature_1_dart16.dart';
import 'package:archisri_1/feature_1_selections.dart';

//living room selection screen (3rd floor living room)

class Feature1Part15 extends StatefulWidget {
  const Feature1Part15({super.key});

  @override
  State<Feature1Part15> createState() => _Feature1Part15State();
}
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  const Text(
                    "How many living rooms should include in third floor?",
                    style: TextStyle(
                      fontSize: 14,
                    ...
                    child: ElevatedButton(
                      onPressed: selectedRooms.isNotEmpty
                          ? () {
                              ...
                              BlueprintSelections.livingRoomSelectionsByFloor['third'] = List<String>.from(selectedRooms);
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => const Feature1Part16()),
                              );
                            }
                          : null,
