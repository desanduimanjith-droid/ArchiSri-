...
import 'package:archisri_1/feature_1_part11.dart';

//bathroom type selection screen

class Feature1Part10 extends StatefulWidget {
  const Feature1Part10({super.key});

  @override
  State<Feature1Part10> createState() => _Feature1Part10State();
}

class _Feature1Part10State extends State<Feature1Part10> {
                      ...
                      ElevatedButton(
                        onPressed: selectedRooms.isNotEmpty
                            ? () {
                                ...
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => const Feature1Part11()),
                                );
                              }
                            : null,
                        style: ElevatedButton.styleFrom(
