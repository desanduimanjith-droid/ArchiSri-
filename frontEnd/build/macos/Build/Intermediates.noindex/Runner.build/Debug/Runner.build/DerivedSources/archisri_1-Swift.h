...
#ifndef ARCHISRI_1_SWIFT_H
#define ARCHISRI_1_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="archisri_1",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC10archisri_111AppDelegate")
...
SWIFT_CLASS("_TtC10archisri_117MainFlutterWindow")
